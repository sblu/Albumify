...
All generated by the `v0.1.0-rank8-preview` model with `--threshold 0.95`. The
*label* column is the Gemini-generated training target; the other columns are
the model's output at the listed `--size`.
