...
Two preview models are published as Releases — pick by size / quality:

| Release | Model size | Quality | Best for |
|:--|:-:|:--|:--|
| [`v0.2.0-ngf96`](https://github.com/sblu/Albumify/releases/tag/v0.2.0-ngf96) | 27 MB | Clearer, bolder lines (**recommended**) | Better recognizability |
| [`v0.1.0-rank8-preview`](https://github.com/sblu/Albumify/releases/tag/v0.1.0-rank8-preview) | 12.6 MB | Faint "ghost" lines | Smallest footprint, fastest on Pi |

Both expect `--threshold 0.95` at inference time.
...
# or, for the smaller v0.1.0-rank8-preview:
# curl -L -o artifacts/model.int8.onnx \
...
albumify --model artifacts/model.int8.onnx \
  ...
  --out line.png \
  --size 256 \
  --threshold 0.95            # lifts faint pixels to clean black
```

### Samples

All generated by the `v0.2.0-ngf96` model with `--threshold 0.95`. The
*label* column is the Gemini-generated training target; the other columns
are the model's output at the listed `--size`.

**Nirvana — Nevermind**

| Training label | 256×256 | 512×512 | 1024×1024 |
|:-:|:-:|:-:|:-:|
| <img src="docs/samples/nevermind-label.png" width="180"> | <img src="docs/samples/nevermind-256.png" width="180"> | <img src="docs/samples/nevermind-512.png" width="180"> | <img src="docs/samples/nevermind-1024.png" width="180"> |

**Pink Floyd — The Wall**

| Training label | 256×256 | 512×512 | 1024×1024 |
|:-:|:-:|:-:|:-:|
| <img src="docs/samples/thewall-label.png" width="180"> | <img src="docs/samples/thewall-256.png" width="180"> | <img src="docs/samples/thewall-512.png" width="180"> | <img src="docs/samples/thewall-1024.png" width="180"> |

**Michael Jackson — Thriller**

| Training label | 256×256 | 512×512 | 1024×1024 |
|:-:|:-:|:-:|:-:|
| <img src="docs/samples/thriller-label.png" width="180"> | <img src="docs/samples/thriller-256.png" width="180"> | <img src="docs/samples/thriller-512.png" width="180"> | <img src="docs/samples/thriller-1024.png" width="180"> |
